...
- **Pacing:** Ex 1-4 everyone, Ex 5-6 most, bonus for speedrunners.
...
- **Ex 5 is the summit.** Budget the most time here. The two `...` fill-ins are `random.choice(next_words[word])` and `output.append(word)`.
- **Funniest sentence competition** at share-out. This is the moment they go home talking about.
