...
def _(mo):
    ...
    *Uses: tokenizing, regex, dictionaries.*
    ...
    and it tells them how "warm" (similar) they are. *Uses: Day 4 skills.*
...
def _(mo):
    ...
    In one week you went from "what's a variable?" to building text-generating
    AI. If you want to keep going:
